...
const DEFAULT_WORDS = ['NYAYA LENS', 'LEGAL SHIELD', 'KNOW YOUR LAW'];
...
const toCssUnit = (value: any) => (typeof value === 'number' ? `${value}px` : value);
...
const createTiles = (phrase: string) =>
...
export const SplitFlapText: React.FC<SplitFlapTextProps> = ({
  words = ['NYAYA LENS', 'LEGAL SHIELD', 'KNOW YOUR LAW'],
  text,
  flipDuration = 0.12,
  stagger = 0.06,
  cycleDelay = 2400,
  ...
  const componentStyle: Record<string, any> = {
