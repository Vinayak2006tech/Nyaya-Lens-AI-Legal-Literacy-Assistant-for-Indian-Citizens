...
export const RiskAnalysisPane: React.FC<RiskAnalysisPaneProps> = ({
  ...
  if (isAnalyzing) {
    return (
      <div className="bg-white border border-slate-200 rounded-2xl shadow-card h-[calc(100vh-140px)] min-h-[600px] flex flex-col items-center justify-center p-8 text-center">
  ...
  if (!analysis) {
    return (
      <div className="bg-white border border-slate-200 rounded-2xl shadow-card h-[calc(100vh-140px)] min-h-[600px] flex flex-col items-center justify-center p-8 text-center">
        <div className="w-14 h-14 rounded-2xl bg-indigo-50 border border-indigo-100 flex items-center justify-center text-indigo-700 mb-4 shadow-sm">
        ...
        <div className="grid grid-cols-2 gap-3 max-w-xs text-left text-xs text-slate-600">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex items-center space-x-3">
            <div className={`w-12 h-12 rounded-xl flex flex-col items-center justify-center font-bold shadow-sm ${
              ...
              <span className="text-base leading-none">{analysis.overall_risk_score}</span>
              <span className="text-[9px] uppercase font-semibold">/ 10</span>
            </div>
            <div>
          ...
          {/* Filter Chips */}
          <div className="flex items-center space-x-1 text-xs bg-slate-200 p-0.5 rounded-lg font-medium">
            <button
              ...
              {clause.fair_template_match && (
                <div className="pt-2 border-t border-slate-100 flex justify-end">
                  <button
                    ...
                    className="inline-flex items-center space-x-1.5 text-xs font-semibold text-indigo-700 bg-indigo-50 hover:bg-indigo-100 border border-indigo-200 px-3 py-1.5 rounded-lg transition-colors shadow-subtle"
                  >
